...
def test_get_environ_vars_positive_some_set():
    ...
    expected_output = {
        ...
        "singlestore.workload.type": DEFAULT_ENV_VARIABLES[
            "SINGLESTOREDB_WORKLOAD_TYPE"
        ],
        "singlestore.nova.app.base.path": DEFAULT_ENV_VARIABLES[
            "SINGLESTOREDB_APP_BASE_PATH"
        ],
        "singlestore.nova.app.base.url": DEFAULT_ENV_VARIABLES[
...
def test_form_otel_collector_endpoint_positive():
    ...
    expected_url = (
        f"http://otel-collector-{project_id}.observability.svc.cluster.local:4317"
    )
