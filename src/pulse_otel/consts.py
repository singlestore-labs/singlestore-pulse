...
PULSE_INTERNAL_COLLECTOR_ENDPOINT = (
    "http://otel-collector-pulse-internal-{NOVA_CELL_PLACEHOLDER}.observability.svc.cluster.local:4317"
)
...
NEXUS_APP_ID = "singlestore.nexus.app.id"
NEXUS_APP_TYPE = "singlestore.nexus.app.type"
DOMAIN_ID = "singlestore.domain.id"
SESSION_ID = "session.id"
CONVERSATION_ID = "gen_ai.conversation.id"
SESSION_ID_ALIAS = "traceloop.association.properties.session.id"
...
BAGGAGE_SESSION = "session"
BAGGAGE_NEXUS_ID = "nexus.app.id"
BAGGAGE_NEXUS_TYPE = "nexus.app.type"
...
DEFAULT_ENV_VARIABLES = {
    ...
    "SINGLESTOREDB_APP_NAME": APP_NAME_PLACEHOLDER,
